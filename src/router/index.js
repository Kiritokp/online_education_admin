...
export const constantRoutes = [
  ...
  // 首页
  {
    ...
    children: [{
      ...
      meta: { title: '霍格沃茨学院首页', icon: 'nested' }
    }]
  }]
/**
 * 动态路由
 ...
 // 讲师管理
  {
    ...
    name: '魔法师管理',
    meta: { title: '魔法师管理', icon: 'example' },
    children: [
      {
        path: 'list',
        name: '魔法师列表',
        component: () => import('@/views/edu/teacher/list'),
        meta: { title: '魔法师列表',icon:'table' }
      },
      {
        path: 'save',
        name: '添加魔法师',
        component: () => import('@/views/edu/teacher/save'),
        meta: { title: '添加魔法师',icon:'user' }
      },
      {
        path: 'edit/:id',
        name: '编辑魔法师',
        component: () => import('@/views/edu/teacher/save'),
        meta: { title: '编辑魔法师', noCache: true ,icon:'form'},
        hidden:true
      }
    ]
  },
  // 课程分类管理
  {
    ...
    name: '魔法课分类管理',
    meta: { title: '魔法课分类管理', icon: 'nested' },
    children: [
      {
        path: 'list',
        name: '魔法课分类列表',
        component: () => import('@/views/edu/subject/list'),
        meta: { title: '魔法课分类列表',icon:'tree' }
      },
      {
        path: 'save',
        name: '导入魔法课分类',
        component: () => import('@/views/edu/subject/save'),
        meta: { title: '导入魔法课分类',icon:'link' }
      }
    ]
  },
  // 课程管理
  {
    ...
    name: '魔法课管理',
    meta: { title: '魔法课管理', icon: '课程' },
    children: [
      {
        path: 'list',
        name: '魔法课列表',
        component: () => import('@/views/edu/course/list'),
        meta: { title: '魔法课列表',icon:'coursetree' }
      },
      {
        path: 'info',
        name: '添加魔法课',
        component: () => import('@/views/edu/course/info'),
        meta: { title: '添加魔法课',icon:'courseadd' }
      },
      {
        path: 'info/:id',
        name: 'EduCourseInfoEdit',
        component: () => import('@/views/edu/course/info'),
        meta: { title: '编辑魔法课基本信息', noCache: true },
        hidden: true
      },
      {
        path: 'chapter/:id',
        ...
        meta: { title: '编辑魔法课大纲', noCache: true },
        hidden: true
      },
      {
        path: 'publish/:id',
  ...
  // 幻灯片管理
  {
    ...
    name: '魔法墙管理',
    meta: { title: '魔法墙管理', icon: 'banner' },
    children: [
      {
        path: 'list',
        name: '魔法墙列表',
        component: () => import('@/views/edu/banner/list'),
        meta: { title: '魔法墙列表',icon:'table' }
      },
      {
        path: 'save',
        name: '添加魔法墙',
        component: () => import('@/views/edu/banner/save'),
        meta: { title: '添加魔法墙',icon:'添加' }
      },
      {
        path: 'edit/:id',
        name: '编辑魔法墙',
        component: () => import('@/views/edu/banner/save'),
        meta: { title: '编辑魔法墙', noCache: true ,icon:'form'},
        hidden:true
      }
    ]
  },
  ...
  //       meta: { title: '添加学员',icon:'user' }
  //     },
  //     {
  //       path: 'edit/:id',
  //       name: '编辑学员',
  //       component: () => import('@/views/edu/student/save'),
  //       meta: { title: '编辑学员', noCache: true ,icon:'form'},
  //       hidden:true
  //     }
  //   ]
  // },
