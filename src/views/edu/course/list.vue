<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="lessonNum" label="总课时"  width="150" align="center"/>

      <el-table-column prop="price" label="课程价格"  width="150" align="center"/>

      <el-table-column prop="buyCount" label="销售数量" width="150" align="center"/>

      <el-table-column prop="viewCount" label="浏览数量" width="150" align="center"/>
